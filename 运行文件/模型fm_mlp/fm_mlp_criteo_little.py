...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/fm_mlp_criteo_little', help='The config directory.')
    parser.add_argument('--expid', type=str, default='fm_mlp_criteo_little', help='The experiment id to run.')
