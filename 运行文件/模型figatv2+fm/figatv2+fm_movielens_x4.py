...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/figatv2+fm_movielens_x4', help='The config directory.')
    parser.add_argument('--expid', type=str, default='figatv2+fm_movielens_x4', help='The experiment id to run.')
