...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/gafm_avazu_x4', help='The config directory.')
    parser.add_argument('--expid', type=str, default='gafm_avazu_x4', help='The experiment id to run.')
