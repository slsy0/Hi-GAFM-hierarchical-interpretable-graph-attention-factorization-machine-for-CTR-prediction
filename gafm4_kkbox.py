...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/gafm4_kkbox_x1', help='The config directory.')
    parser.add_argument('--expid', type=str, default='gafm4_kkbox_x1', help='The experiment id to run.')
    ...
    # model = torch.load('./checkpoints/kkbox_x1/gafm4_kkbox_x1.model')
    ...
    # path = './model.pth'
    path = './model.h5'
    # state = {'model': model.state_dict(), 'optimizer': model.optimizer.state_dict(), 'epoch': model.epoch}
