...
class FiGATv2_Layer3(nn.Module):
    def __init__(self,
                 num_fields,
                 embedding_dim,
                 gat_layers=3,
                 ...
                 use_residual=True,
                 device=None):
        super(FiGATv2_Layer3, self).__init__()
    ...
    def build_graph(self, feature_emb):
        src_emb = feature_emb[:, self.src_nodes, :]  # source
        dst_emb = feature_emb[:, self.dst_nodes, :]  # destination
