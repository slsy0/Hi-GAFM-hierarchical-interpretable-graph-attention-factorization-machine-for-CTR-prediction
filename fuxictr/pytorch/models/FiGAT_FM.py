...
class FiGAT_FM(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(FiGAT_FM, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
    ...
    def forward(self, inputs):
        ...
        b = feature_emb.view(-1, self.embedding_dim)
        b = self.gru(b, a)
        b = b.view(-1, self.num_fields, self.embedding_dim)
        b += feature_emb  # use residual
        h_out = b
