...
from fuxictr.pytorch.layers import EmbeddingLayer, FiGATv2_Layer, FM_Layer, InnerProductLayer, LR_Layer
import pdb


class FiGATv2_FM(BaseModel):
    def __init__(self,
                 feature_map,
                 model_id="FiGAT_FM",
                 gpu=-1,
                 ...
                 **kwargs):
        super(FiGATv2_FM, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
