...
class ONN(BaseModel):
    ...
    def forward(self, inputs):
        ...
        # 39 list of bs x f x emb_dim

        copy_embedding = field_aware_emb_list[0].flatten(start_dim=1)  # embedding features   bs x f*emb_dim
        ffm_out = self.field_aware_interaction(field_aware_emb_list[1:])  # interaction features
