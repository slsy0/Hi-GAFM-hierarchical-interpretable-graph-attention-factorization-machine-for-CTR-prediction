...
from fuxictr.pytorch.layers import EmbeddingLayer, FiGATv2_Layer3, FM_Layer, InnerProductLayer, LR_Layer, MLP_Layer
...
class GAFM3v2(BaseModel):
    def __init__(self,
                 ...
                 **kwargs):
        super(GAFM3v2, self).__init__(feature_map,
                                    model_id=model_id,
                                    gpu=gpu,
        ...
        self.att_w = FiGATv2_Layer3(self.num_fields,
                                  self.embedding_dim,
    ...
    def forward(self, inputs):
        ...
        fc_input = self.self_attention(fc_input)
        y_pred = self.fc3(fc_input)
        # y_pred = self.attentional_score(fc_input)
