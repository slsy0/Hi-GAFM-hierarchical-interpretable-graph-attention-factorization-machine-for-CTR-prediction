...
from fuxictr.pytorch.layers import EmbeddingLayer, FiGAT_Layer2, FM_Layer, InnerProductLayer, LR_Layer
from fuxictr.pytorch.layers import BilinearInteractionLayer
import pdb


class GAFM(BaseModel):
    def __init__(self,
                 feature_map,
                 model_id="FiGAT_FM",
                 gpu=-1,
                 ...
                 **kwargs):
        super(GAFM, self).__init__(feature_map,
                                   model_id=model_id,
                                   gpu=gpu,
